...
public class musicRecommendationRealm extends JdbcRealm {

	private Logger logger = LoggerFactory.getLogger(musicRecommendationRealm.class);

	private String appAuthenticationQuery = "select password from users where username = ?";
	...
	public musicRecommendationRealm() {
