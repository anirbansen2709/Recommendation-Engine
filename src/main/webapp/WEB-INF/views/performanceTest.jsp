            ...
            <div class="col-lg-12">
                ...
                <div role="tabpanel" class="panel panel-transparent">
                    ...
                    <ul role="tablist" class="nav nav-tabs nav-justified">
                        <li role="presentation" id="ram" class="active">
                            <a href="#home" aria-controls="home" role="tab" data-toggle="tab" class="bb0">
                                <em class="fa fa-flash fa-fw fa-lg"></em>RAM Test <b id="limit2GB">  (default 2GB)</b></a>
                        </li>
                        <li role="presentation" id="driveSpace">
                            <a href="#profile" aria-controls="profile" role="tab" data-toggle="tab" class="bb0">
                                <em class="fa fa-folder-open fa-fw fa-lg"></em>Drive Space Test</a>
                        </li>
                    </ul>
                    <!-- Tab panes-->
                    <div class="tab-content p0 bg-white">
                        <div id="home" role="tabpanel" class="tab-pane active">
                            <!-- START list group-->
                            <div id="style21" class="tableHide">
                                <table id="exampleRam" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead id="theadRam"></thead>
                        ...
                        <div id="profile" role="tabpanel" class="tab-pane">
                            <!-- START list group-->
                            <div id="style22" class="tableHide">
                                <table id="exampleDriveSpace" class="table table-striped table-bordered" cellspacing="0"
                                       width="100%">
                                    <thead id="theadDriveSpace"></thead>
                                    <tbody id="tbodyDriveSpace"></tbody>
                                </table>
                            </div>
                ...
                <div class="widget">
                    ...
                    <div class="row row-table">
                        <div class="col-xs-12">
                            ...
                            <div class="col-xs-5">
                                <div class="numbers-row">
                                    <input type="text" id="bytes2" value="KB">
                                </div>
...
<script>
    ...
    function submitStartDateEndDate() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (deviceIdentifier == "driveSpace") {
                    createDriveSpaceBody(response);
                }
    ...
    function submitLimit() {
        ...
        $.ajax({
            url: "submitLim",
            data: "Data=" + data + "&bytes=" + bytes + "&deviceId=" + deviceIdentifier,
            success: function (response) {
                $("#limitModel").modal("hide");
                        response = jQuery.parseJSON(response);
                        createRamBody(response);
                }
                ,
                error: function (e) {
                    alert('Error: ' + e);
